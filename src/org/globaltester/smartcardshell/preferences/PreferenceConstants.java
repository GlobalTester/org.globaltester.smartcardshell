...
public class PreferenceConstants {
	...
	public static final String OCF_CONFIGURATION_SOURCE_default = "default"; // configure OCF from default opencard.properties file(s)
	public static final String OCF_CONFIGURATION_SOURCE_file = "file"; // configure OCF from user specified opencard.properties file
	public static final String OCF_CONFIGURATION_SOURCE_preferences = "preferences"; // configure OCF from preferences
